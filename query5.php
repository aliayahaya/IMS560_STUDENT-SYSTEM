...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['advisor_id'])) {
    ...
    // SQL Query: Select students enrolled in the given advisor
    $sql = "SELECT student_id, student_name FROM student WHERE advisor_id = '$advisor_id'";

    $result = $conn->query($sql);

    echo "<h2>Students Enrolled under Advisor ID: $advisor_id</h2>";
