...
<head>
    <meta charset="UTF-8">
    <title>Enroll Lecturer in Subject</title>
...
<body>
    <div class="content">
        <h2>Enroll Lecturer in Subject</h2>
        <form action="process_enroll_lecturer.php" method="post">
...
. $row['lecturer_id'] . " - " . $row['lecturer_name'] . "</option>";
}
}
$conn->close();
?>
